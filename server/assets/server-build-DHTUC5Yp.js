...
const DecoderText = memo(
  ({ text: text2, start = true, delay: startDelay = 0, className, ...rest }) => {
    ...
    useEffect(() => {
      ...
      const renderOutput = () => {
        const characterMap = output.current.map((item2) => {
          return `<span class="${styles$E[item2.type]}">${item2.value}</span>`;
        });
    ...
    return /* @__PURE__ */ jsxs("span", { className: classes(styles$E.text, className), ...rest, children: [
      ...
      /* @__PURE__ */ jsx("span", { "aria-hidden": true, className: styles$E.content, ref: container2 })
    ] });
  }
);
...
const description$f = "_description_memxv_185";
  ...
  return /* @__PURE__ */ jsxs("section", { className: styles$C.page, children: [
    ...
    /* @__PURE__ */ jsx(Transition, { in: true, children: ({ visible }) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
      /* @__PURE__ */ jsx("div", { className: styles$C.details, children: /* @__PURE__ */ jsxs("div", { className: styles$C.text, children: [
        ...
        /* @__PURE__ */ jsx(Text, { className: styles$C.description, "data-visible": visible, as: "p", children: message }),
        flatlined ? /* @__PURE__ */ jsx(
          Button,
          {
            secondary: true,
      ...
      /* @__PURE__ */ jsxs("div", { className: styles$C.videoContainer, "data-visible": visible, children: [
        /* @__PURE__ */ jsx(
          Image$1,
          {
            reveal: true,
...
const Monogram = forwardRef(({ className, ...props }, ref) => {
  const id = useId();
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("clipPath", { id: clipId, children: [
          ...
          /* @__PURE__ */ jsx("path", { d: "M3303 2552 c-281 -100 -397 -447 -239 -717 83 -141 258 -228 425 -211 250 26 415 213 415 471 0 197 -95 354 -264 438 -59 29 -74 32 -175 35 -87 2 -121 -2 -162 -16z m235 -62 c157 -70 254 -294 217 -503 -34 -195 -144 -317 -285 -317 -146 0 -271 124 -320 316 -37 144 -24 271 40 376 85 140 213 187 348 128z" })
        ] }) }),
        /* @__PURE__ */ jsx("g", { clipPath: `url(#${clipId})`, fill: "white", children: /* @__PURE__ */ jsx("g", { transform: "translate(0.000000,420.000000) scale(0.100000,-0.100000)", children: /* @__PURE__ */ jsxs("g", { fill: "white", stroke: "black", children: [
...
const name$2 = "Océane Rakotomalala";
const role = "Développeur";
const disciplines = [
  "Intégration",
  "Graphisme"
];
const url$1 = "https://oceane86.github.io/portfolio_ok/index.html";
const github = "Oceane86";
const repo = "https://github.com/Oceane86/portfolio_ok";
...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxs("header", { className: styles$x.navbar, ref: headerRef, children: [
    /* @__PURE__ */ jsx(
      Link$1,
      {
        unstable_viewTransition: true,
    ...
    /* @__PURE__ */ jsxs("nav", { className: styles$x.nav, children: [
      /* @__PURE__ */ jsx("div", { className: styles$x.navList, children: navLinks.map(({ label: label2, pathname }) => /* @__PURE__ */ jsx(
        Link$1,
        {
          unstable_viewTransition: true,
          prefetch: "intent",
    ...
    /* @__PURE__ */ jsx(Transition, { unmount: true, in: menuOpen, timeout: msToNum(tokens.base.durationL), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs("nav", { className: styles$x.mobileNav, "data-visible": visible, ref: nodeRef, children: [
...
const NavbarIcons = ({ desktop }) => /* @__PURE__ */ jsx("div", { className: styles$x.navIcons, children: socialLinks.map(({ label: label2, url: url2, icon: icon2 }) => /* @__PURE__ */ jsx(
  "a",
  {
    "data-navbar-item": desktop || void 0,
    className: styles$x.navIconLink,
    "aria-label": label2,
    href: url2,
    target: "_blank",
    rel: "noopener noreferrer",
    children: /* @__PURE__ */ jsx(Icon, { className: styles$x.navIcon, icon: icon2 })
  },
  label2
)) });
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: styles$s.options, children: [
              !!indicator2 && /* @__PURE__ */ jsx(
                "div",
                {
                  className: styles$s.indicator,
...
const Section = forwardRef(
  ({ as: Component = "div", children, className, ...rest }, ref) => /* @__PURE__ */ jsx(Component, { className: classes(styles$r.section, className), ref, ...rest, children })
);
...
const description$e = "_description_7xwsz_272";
const linkButton = "_linkButton_7xwsz_282";
const meta$i = "_meta_7xwsz_292";
...
function ProjectHeader({
  ...
  return /* @__PURE__ */ jsx(Section, { className: classes(styles$q.header, className), as: "section", children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: styles$q.headerContent,
      style: cssProps({ initDelay: numToMs(initDelay) }),
      children: [
        /* @__PURE__ */ jsxs("div", { className: styles$q.details, children: [
          /* @__PURE__ */ jsx(Heading, { className: styles$q.title, level: 2, as: "h1", children: title2 }),
          /* @__PURE__ */ jsx(Text, { className: styles$q.description, size: "xl", as: "p", children: description2 }),
          !!url2 && /* @__PURE__ */ jsx(
            Button,
            {
              secondary: true,
              iconHoverShift: true,
              className: styles$q.linkButton,
              icon: "chevron-right",
              href: url2,
              children: linkLabel
            }
        ...
        !!(roles2 == null ? void 0 : roles2.length) && /* @__PURE__ */ jsx("ul", { className: styles$q.meta, children: roles2 == null ? void 0 : roles2.map((role2, index2) => /* @__PURE__ */ jsx(
          "li",
          {
            className: styles$q.metaItem,
...
const ProjectContainer = ({ className, ...rest }) => /* @__PURE__ */ jsx("article", { className: classes(styles$q.project, className), ...rest });
const ProjectSection = forwardRef(
  ({
    ...
    "section",
    {
      className: classes(styles$q.section, className),
      "data-light": light2,
      ...
      children: [
        !!backgroundElement && /* @__PURE__ */ jsx(
          "div",
          {
            className: styles$q.sectionBackground,
            style: cssProps({ opacity: backgroundOverlayOpacity }),
            children: backgroundElement
          }
        ),
        /* @__PURE__ */ jsx(Section, { className: styles$q.sectionInner, "data-padding": padding, children })
      ]
    }
  )
);
const ProjectBackground = ({ opacity = 0.7, className, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Transition, { in: true, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs(
    "div",
    {
      className: classes(styles$q.backgroundImage, className),
      "data-visible": visible,
      ref: nodeRef,
      children: [
        /* @__PURE__ */ jsx("div", { className: styles$q.backgroundImageElement, ref: imageRef, children: /* @__PURE__ */ jsx(Image$1, { cover: true, alt: "", role: "presentation", ...rest }) }),
        /* @__PURE__ */ jsx("div", { className: styles$q.backgroundScrim, style: cssProps({ opacity }) })
      ]
    }
  ) });
};
const ProjectImage = ({ className, alt, ...rest }) => /* @__PURE__ */ jsx("div", { className: classes(styles$q.image, className), children: /* @__PURE__ */ jsx(Image$1, { reveal: true, alt, delay: 300, ...rest }) });
const ProjectSectionContent = ({ className, width = "l", ...rest }) => /* @__PURE__ */ jsx(
  "div",
  {
    className: classes(styles$q.sectionContent, className),
    "data-width": width,
    ...rest
  }
);
const ProjectSectionHeading = ({ className, level = 3, as = "h2", ...rest }) => /* @__PURE__ */ jsx(
  Heading,
  {
    className: classes(styles$q.sectionHeading, className),
    as,
    level,
    align: "auto",
    ...rest
...
const ProjectSectionText = ({ className, ...rest }) => /* @__PURE__ */ jsx(Text, { className: classes(styles$q.sectionText, className), size: "l", as: "p", ...rest });
const ProjectTextRow = ({
  ...
  "div",
  {
    className: classes(styles$q.textRow, className),
    "data-center": center,
...
const ProjectSectionColumns = ({ className, centered, ...rest }) => /* @__PURE__ */ jsx(
  ...
  {
    className: classes(styles$q.sectionColumns, className),
...
const video$7 = "_video_so4tl_1";
const sidebarImages$9 = "_sidebarImages_so4tl_13";
const sidebarImage$9 = "_sidebarImage_so4tl_13";
const styles$p = {
  video: video$7,
  sidebarImages: sidebarImages$9,
  sidebarImage: sidebarImage$9
};
const Earth$7 = lazy(() => import("./earth-CDICkS34.js").then((module) => ({ default: module.Earth })));
const EarthSection$7 = lazy(
  () => import("./earth-CDICkS34.js").then((module) => ({ default: module.EarthSection }))
);
const title$f = "Art Côté Jardin";
const description$d = "Ce projet a été réalisé avec un client réel qui est une application permettant de mettre en relation des pratiquants une même activité physique, pour pouvoir trouver un lieu ou unc coach. Nous avons dû créer un site internet.";
const roles$b = [
  "UX and UI Design",
  "Front End Development"
];
const meta$h = () => {
  return baseMeta({ title: title$f, description: description$d, prefix: "Projects" });
};
const ArtCoteJardin = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$p.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$p.sidebarImage,
...
const Carousel = lazy(
  () => import("./index-Cv0g6jc1.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-B8fxqWbU.js").then((module) => ({ default: module.Armor })));
const title$e = "Volkihar Knight";
const description$c = "A lore-friendly armor mod for The Elder Scrolls V: Skyrim. Released on PC and Xbox One with over one million downloads across both platforms.";
const roles$a = ["3D Modelling", "Texturing", "Graphic Design"];
const meta$g = () => {
  return baseMeta({ title: title$e, description: description$c, prefix: "Projects" });
};
function VolkiharKnight() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$o.armor, children: /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(Armor, { alt: "3D model of the Volkihar Knight armor" }) }) }),
        /* @__PURE__ */ jsxs("div", { className: styles$o.textSection, children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionContent, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$o.logoContainer, children: /* @__PURE__ */ jsx(
          VolkiharLogo,
          {
            role: "img",
...
const sliceAppLarge = "/assets/haddah-jeu-screen-C-chp7Xe.png";
...
const sliceBackgroundPlaceholder = "/assets/hadddah-jeu-gameplay-QdvR4JP4.png";
const sliceBackground = "/assets/slice-background-5195om16.jpg";
const sliceSidebarAnnotationsLarge = "/assets/haddah-jeu-gameplay-2-C4SIhJeE.png";
...
const columns$1 = "_columns_sh3b4_1";
const grid$2 = "_grid_sh3b4_5";
const gridImage$1 = "_gridImage_sh3b4_16";
const gridBackground$1 = "_gridBackground_sh3b4_28";
const gridForeground$1 = "_gridForeground_sh3b4_41";
const gridText$1 = "_gridText_sh3b4_57";
const sidebarImages$8 = "_sidebarImages_sh3b4_69";
const sidebarImagesText$1 = "_sidebarImagesText_sh3b4_85";
const sidebarImage$8 = "_sidebarImage_sh3b4_69";
const styles$n = {
  columns: columns$1,
  grid: grid$2,
  gridImage: gridImage$1,
  gridBackground: gridBackground$1,
  gridForeground: gridForeground$1,
  gridText: gridText$1,
  sidebarImages: sidebarImages$8,
  sidebarImagesText: sidebarImagesText$1,
  sidebarImage: sidebarImage$8
};
const title$d = "Jeu : La quête magique d Haddah";
const description$b = "Créé et développé un jeu autour duquel nous avons mis en place une stratégie de promotion notamment par la réalisation d’un trailer promotionnel. À l’aide de différents outils comme Stencyl et plateformes comme Itch.io. Nous avons mis en place un prototype du jeu vidéo en moins d’une semaine.";
const roles$9 = ["Développeur", "Stencyl"];
const meta$f = () => {
  return baseMeta({ title: title$d, description: description$b, prefix: "Projects" });
};
const Calculatrice = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { className: styles$n.slice, children: [
      /* @__PURE__ */ jsx(
        ProjectBackground,
        {
          src: sliceBackground,
          srcSet: `${sliceBackground} 1280w, ${sliceBackgroundPlaceholder} 2560w`,
          width: 1280,
          height: 800,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "top", children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsx(
        ProjectImage,
        {
          srcSet: `${sliceAppLarge} 800w, ${sliceAppLarge} 1920w`,
          width: 800,
          height: 500,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { centered: true, className: styles$n.columns, children: [
        /* @__PURE__ */ jsxs("div", { className: styles$n.imagesText, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$n.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$n.sidebarImage,
              srcSet: `${sliceSidebarAnnotationsLarge} 350w, ${sliceSidebarAnnotationsLarge} 700w`,
              width: 350,
              height: 750,
...
const video$6 = "_video_so4tl_1";
const sidebarImages$7 = "_sidebarImages_so4tl_13";
const sidebarImage$7 = "_sidebarImage_so4tl_13";
const styles$m = {
  video: video$6,
  sidebarImages: sidebarImages$7,
  sidebarImage: sidebarImage$7
};
const Earth$6 = lazy(() => import("./earth-DFYnB5ag.js").then((module) => ({ default: module.Earth })));
const EarthSection$6 = lazy(
  () => import("./earth-DFYnB5ag.js").then((module) => ({ default: module.EarthSection }))
);
const title$c = "Puppy Clean";
const description$a = "Ce projet a été réalisé avec un client réel qui est une application permettant de mettre en relation des pratiquants une même activité physique, pour pouvoir trouver un lieu ou unc coach. Nous avons dû créer un site internet.";
const roles$8 = [
  "UX and UI Design",
  "Front End Development",
  "Flutter"
...
const meta$e = () => {
  return baseMeta({ title: title$c, description: description$a, prefix: "Projects" });
};
const PuppyClean = () => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === "dark";
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$m.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$m.sidebarImage,
              srcSet: isDark ? `${imageSprSchema2Dark} 260w, ${imageSprSchema2DarkLarge} 520w` : `${imageSprSchema2Light} 260w, ${imageSprSchema2LightLarge} 520w`,
              width: 260,
              height: 660,
              placeholder: isDark ? imageSprSchema2DarkPlaceholder : imageSprSchema2LightPlaceholder,
...
function ArticlesPost({ slug, frontmatter: frontmatter2, timecode: timecode2, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxs(
    "article",
    {
      className: styles$k.post,
      "data-featured": !!featured,
      style: index2 !== void 0 ? cssProps({ delay: index2 * 100 + 200 }) : void 0,
      children: [
        featured && /* @__PURE__ */ jsx(Text, { className: styles$k.postLabel, size: "s", children: "Featured" }),
        featured && !!banner2 && /* @__PURE__ */ jsx("div", { className: styles$k.postImage, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            noPauseButton: true,
        ...
        /* @__PURE__ */ jsx(
          Link$1,
          {
            ...
            prefetch: "intent",
            to: `/articles/${slug}`,
            className: styles$k.postLink,
            onMouseEnter: handleMouseEnter,
            onMouseLeave: handleMouseLeave,
            children: /* @__PURE__ */ jsxs("div", { className: styles$k.postDetails, children: [
              /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$k.postDate, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: styles$k.postFooter, children: [
                /* @__PURE__ */ jsx(Button, { secondary: true, iconHoverShift: true, icon: "chevron-right", as: "div", children: "Read article" }),
                /* @__PURE__ */ jsx(Text, { className: styles$k.timecode, size: "s", children: timecode2 })
              ] })
            ] })
          }
        ),
        featured && /* @__PURE__ */ jsx(Text, { "aria-hidden": true, className: styles$k.postTag, size: "s", children: "477" })
      ]
    }
  );
}
function SkeletonPost({ index: index2 }) {
  return /* @__PURE__ */ jsx(
    ...
    {
      "aria-hidden": "true",
      className: classes(styles$k.post, styles$k.skeleton),
      "data-featured": "false",
      style: index2 !== void 0 ? cssProps({ delay: index2 * 100 + 200 }) : void 0,
      children: /* @__PURE__ */ jsx("div", { className: styles$k.postLink, children: /* @__PURE__ */ jsxs("div", { className: styles$k.postDetails, children: [
        /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$k.postDate, children: [
          /* @__PURE__ */ jsx(Divider, { notchWidth: "64px", notchHeight: "8px" }),
          "Coming soon..."
        ] }),
        /* @__PURE__ */ jsx(
          Heading,
          {
            className: styles$k.skeletonBone,
            as: "h2",
            level: 4,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$k.postFooter, children: [
          ...
          /* @__PURE__ */ jsx(Text, { className: styles$k.timecode, size: "s", children: "00:00:00:00" })
        ] })
      ] }) })
    }
  );
...
function Articles$1() {
  ...
  const postsHeader = /* @__PURE__ */ jsxs("header", { className: styles$k.header, children: [
    /* @__PURE__ */ jsx(Heading, { className: styles$k.heading, level: 5, as: "h1", children: /* @__PURE__ */ jsx(DecoderText, { text: "Latest articles" }) }),
    /* @__PURE__ */ jsx(Barcode, { className: styles$k.barcode })
  ] });
  const postList = /* @__PURE__ */ jsxs("div", { className: styles$k.list, children: [
  ...
  return /* @__PURE__ */ jsxs("article", { className: styles$k.articles, children: [
    /* @__PURE__ */ jsxs(Section, { className: styles$k.content, children: [
      !isSingleColumn && /* @__PURE__ */ jsxs("div", { className: styles$k.grid, children: [
        postList,
        featuredPost
      ] }),
      isSingleColumn && /* @__PURE__ */ jsxs("div", { className: styles$k.grid, children: [
...
const video$5 = "_video_so4tl_1";
const sidebarImages$6 = "_sidebarImages_so4tl_13";
const sidebarImage$6 = "_sidebarImage_so4tl_13";
const styles$j = {
  video: video$5,
  sidebarImages: sidebarImages$6,
  sidebarImage: sidebarImage$6
};
const Earth$5 = lazy(() => import("./earth-CempQYc5.js").then((module) => ({ default: module.Earth })));
const EarthSection$5 = lazy(
  () => import("./earth-CempQYc5.js").then((module) => ({ default: module.EarthSection }))
);
const title$b = "morpion";
const description$9 = "Ce projet a été réalisé avec un client réel qui est une application permettant de mettre en relation des pratiquants une même activité physique, pour pouvoir trouver un lieu ou unc coach. Nous avons dû créer un site internet.";
const roles$7 = [
  "UX and UI Design",
  "Front End Development",
  "Javascript"
...
const meta$c = () => {
  return baseMeta({ title: title$b, description: description$9, prefix: "Projects" });
};
const Morpion = () => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === "dark";
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$j.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$j.sidebarImage,
              srcSet: isDark ? `${imageSprSchema2Dark} 260w, ${imageSprSchema2DarkLarge} 520w` : `${imageSprSchema2Light} 260w, ${imageSprSchema2LightLarge} 520w`,
              width: 260,
              height: 660,
              placeholder: isDark ? imageSprSchema2DarkPlaceholder : imageSprSchema2LightPlaceholder,
...
const video$4 = "_video_so4tl_1";
const sidebarImages$5 = "_sidebarImages_so4tl_13";
const sidebarImage$5 = "_sidebarImage_so4tl_13";
const styles$i = {
  video: video$4,
  sidebarImages: sidebarImages$5,
  sidebarImage: sidebarImage$5
};
const Earth$4 = lazy(() => import("./earth-PfKFGCQ2.js").then((module) => ({ default: module.Earth })));
const EarthSection$4 = lazy(
  () => import("./earth-PfKFGCQ2.js").then((module) => ({ default: module.EarthSection }))
);
...
const meta$b = () => {
  return baseMeta({ title: title$a, description: description$8, prefix: "Projects" });
};
const Netflix = () => {
  const { theme, toggleTheme } = useTheme();
  const isDark = theme === "dark";
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$i.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$i.sidebarImage,
              srcSet: isDark ? `${imageSprSchema2Dark} 260w, ${imageSprSchema2DarkLarge} 520w` : `${imageSprSchema2Light} 260w, ${imageSprSchema2LightLarge} 520w`,
              width: 260,
              height: 660,
              placeholder: isDark ? imageSprSchema2DarkPlaceholder : imageSprSchema2LightPlaceholder,
...
const sprTextureLarge = "/assets/yaspeez-screen-large-DpVx_5Og.webp";
const imageYaspeezWebLight = "/assets/yaspeez-screen-CXkNgLZS.webp";
const imageMockupLightPlaceholder = "/assets/yaspeez-Mockup-DI2F-Qdo.webp";
const title$9 = "YASPEEZ";
const description$7 = "Ce projet a été réalisé avec un client réel qui est une application permettant de mettre en relation des pratiquants une même activité physique, pour pouvoir trouver un lieu ou unc coach. Nous avons dû créer un site internet.";
const roles$5 = [
  "UX et UI Design",
  "Front End Development",
  "Wordpress"
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "top", children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsx(
        ...
        {
          raised: true,
          srcSet: isDark ? `${imageMockupLightPlaceholder} 1280w, ${imageMockupLightPlaceholder} 2560w` : `${imageMockupLightPlaceholder} 1280w, ${imageMockupLightPlaceholder} 2560w`,
          width: 1280,
          height: 800,
          placeholder: isDark ? imageMockupLightPlaceholder : imageMockupLightPlaceholder,
          sizes: `(max-width: ${media.mobile}px) 100vw, (max-width: ${media.tablet}px) 800px, 1000px`,
          alt: "The aero lesson builder app dragging an audio component into a screen about plant cells."
        },
        theme
...
const video$3 = "_video_so4tl_1";
const sidebarImages$4 = "_sidebarImages_so4tl_13";
const sidebarImage$4 = "_sidebarImage_so4tl_13";
const styles$h = {
  video: video$3,
  sidebarImages: sidebarImages$4,
  sidebarImage: sidebarImage$4
};
const Earth$3 = lazy(() => import("./earth-B10p3fUc.js").then((module) => ({ default: module.Earth })));
const EarthSection$3 = lazy(
  () => import("./earth-B10p3fUc.js").then((module) => ({ default: module.EarthSection }))
);
...
const sidebarImages$3 = "_sidebarImages_sh3b4_69";
const sidebarImagesText = "_sidebarImagesText_sh3b4_85";
const sidebarImage$3 = "_sidebarImage_sh3b4_69";
const styles$g = {
  columns,
  grid,
  gridImage,
...
const title$7 = "Jeu : La quête magique d Haddah";
const description$5 = "Créé et développé un jeu autour duquel nous avons mis en place une stratégie de promotion notamment par la réalisation d’un trailer promotionnel. À l’aide de différents outils comme Stencyl et plateformes comme Itch.io. Nous avons mis en place un prototype du jeu vidéo en moins d’une semaine.";
const roles$3 = ["Développeur", "Stencyl"];
const meta$8 = () => {
  return baseMeta({ title: title$7, description: description$5, prefix: "Projects" });
};
const Slice = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { className: styles$g.slice, children: [
      /* @__PURE__ */ jsx(
        ProjectBackground,
        {
          src: sliceBackground,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { centered: true, className: styles$g.columns, children: [
        /* @__PURE__ */ jsxs("div", { className: styles$g.imagesText, children: [
          /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Bringing it together" }),
          /* @__PURE__ */ jsx(ProjectSectionText, { children: "Teachers needed a better way to create collaborative group activities by annotating slides on Slice. Before starting this project, a layer could only be annotated by a single user, making it difficult for learners to work together." }),
          /* @__PURE__ */ jsx(ProjectSectionText, { children: "Our solution was to allow users to be invited to a layer, where they can see others’ annotations and make their own." })
        ] }),
...
const video$2 = "_video_so4tl_1";
const sidebarImages$2 = "_sidebarImages_so4tl_13";
const sidebarImage$2 = "_sidebarImage_so4tl_13";
const styles$f = {
  video: video$2,
  sidebarImages: sidebarImages$2,
  sidebarImage: sidebarImage$2
};
const Earth$2 = lazy(() => import("./earth-CQJrdB0d.js").then((module) => ({ default: module.Earth })));
const EarthSection$2 = lazy(
  () => import("./earth-CQJrdB0d.js").then((module) => ({ default: module.EarthSection }))
);
const title$6 = "Snake";
...
const Earth$1 = lazy(() => import("./earth-BVNfVhH8.js").then((module) => ({ default: module.Earth })));
const EarthSection$1 = lazy(
  () => import("./earth-BVNfVhH8.js").then((module) => ({ default: module.EarthSection }))
);
const title$5 = "Loto";
const description$3 = "Ce projet a été réalisé avec un client réel qui est une application permettant de mettre en relation des pratiquants une même activité physique, pour pouvoir trouver un lieu ou unc coach. Nous avons dû créer un site internet.";
const roles$1 = [
  "UX and UI Design",
  "Front End Development",
  "Flutter"
...
const sidebarImages = "_sidebarImages_so4tl_13";
const sidebarImage = "_sidebarImage_so4tl_13";
const styles$d = {
  video,
  sidebarImages,
  sidebarImage
};
const Earth = lazy(() => import("./earth-DAivCi7W.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-DAivCi7W.js").then((module) => ({ default: module.EarthSection }))
);
const title$4 = "Node";
...
async function loader$2({ request }) {
  ...
  const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => Promise.resolve().then(() => route5), "../articles.modern-styling-in-react.mdx": () => Promise.resolve().then(() => route1) }), `../articles.${slug}.mdx`);
  const text2 = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => import("./articles.hello-world-C3lWsiOj.js"), "../articles.modern-styling-in-react.mdx": () => import("./articles.modern-styling-in-react-D1jt5bSr.js") }), `../articles.${slug}.mdx`);
  const readTime = readingTime(text2.default);
...
const gamestackTexture2Large = "/assets/puppy-clean-services-MgcEzbfk.webp";
...
const gamestackTextureLarge = "/assets/puppy-clean-screen-Dc8O7RIq.webp";
...
const gamestackTexture = "/assets/puppy-clean-screen-Dc8O7RIq.webp";
const sliceTextureLarge = "/assets/haddah-jeu-CVOu4CXo.webp";
const pythonTextureLarge = "/assets/snake-BKu_GtXW.webp";
const morpionTexturePlaceholder = "/assets/morpion-screen-Ca9-aozN.webp";
const flyersTexturePlaceholder = "/assets/depliant-eclairage-a1bsr9wE.jpg";
const pythonTexturePlaceholder = "/assets/snake2-C0f_C99F.png";
const calculatriceTexturePlaceholder = "/assets/calculatrice-screen-Gpgk1Qc4.webp";
const myNetflixTexturePlaceholder = "/assets/mynetflix-screen-KVSz6ufW.webp";
const lotoTexturePlaceholder = "/assets/loto-screen-B1ygtjCW.webp";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-CaLkL_54.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const katakana = "/assets/katakana-OOLUAvFq.svg";
...
const Model = lazy(
  () => import("./index-DEWgsM91.js").then((module) => ({ default: module.Model }))
);
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${pythonTexturePlaceholder} 800w, ${pythonTextureLarge} 1920w`,
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${morpionTexturePlaceholder} 800w, ${morpionTexturePlaceholder} 1920w`,
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${calculatriceTexturePlaceholder} 800w, ${calculatriceTexturePlaceholder} 1920w`,
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${flyersTexturePlaceholder} 800w, ${flyersTexturePlaceholder} 1920w`,
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${myNetflixTexturePlaceholder} 800w, ${myNetflixTexturePlaceholder} 1920w`,
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${lotoTexturePlaceholder} 800w, ${lotoTexturePlaceholder} 1920w`,
...
const serverManifest = { "entry": { "module": "/assets/entry.client-BbSqk_uA.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-BOSJh8Jw.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/index-BXn5pOIG.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/use-spring-KDm3mUsa.js", "/assets/decoder-text-D_l7SzBd.js", "/assets/image-oJgo2LrI.js", "/assets/error-CDMDmfeF.js", "/assets/useScrollToHash-eW_re39o.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/config-DwugsCvJ.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/image-CQFqa4Pm.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/error-CmEnn51Q.css", "/assets/root-3CgR45Fi.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-DGKst1eD.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.art-cote-jardin": { "id": "routes/projects.art-cote-jardin", "parentId": "root", "path": "projects/art-cote-jardin", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DDylFcsz.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DSd54C9T.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-BT5UbU5w.css"] }, "routes/projects.calculatrice": { "id": "routes/projects.calculatrice", "parentId": "root", "path": "projects/calculatrice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BpIXEmzc.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/slice-sidebar-layers-placeholder-DN2Qc8rU.js", "/assets/slice-app-placeholder-BfRsQMSa.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-BMFIlMHl.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-YblCpcvN.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.puppy-clean": { "id": "routes/projects.puppy-clean", "parentId": "root", "path": "projects/puppy-clean", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CipbF7kB.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BHhspltn.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/index-BXn5pOIG.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/use-spring-KDm3mUsa.js", "/assets/meta-B1CoTWRj.js", "/assets/decoder-text-D_l7SzBd.js", "/assets/divider-DbfiyrM1.js", "/assets/image-oJgo2LrI.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/date-DvyCAN0s.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/divider-CJ0zz9kw.css", "/assets/image-CQFqa4Pm.css", "/assets/route-DtSYASGB.css"] }, "routes/projects.morpion": { "id": "routes/projects.morpion", "parentId": "root", "path": "projects/morpion", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-ci7HoQCJ.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/projects.netflix": { "id": "routes/projects.netflix", "parentId": "root", "path": "projects/netflix", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Fo2SAS2r.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/projects.yaspeez": { "id": "routes/projects.yaspeez", "parentId": "root", "path": "projects/yaspeez", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DEWQ_8Qe.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/yaspeez-screen-large-DTY4msaF.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css"] }, "routes/projects.flyers": { "id": "routes/projects.flyers", "parentId": "root", "path": "projects/flyers", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BCcmqx3w.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Na0fjS1V.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/slice-sidebar-layers-placeholder-DN2Qc8rU.js", "/assets/slice-app-placeholder-BfRsQMSa.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-BMFIlMHl.css"] }, "routes/projects.snake": { "id": "routes/projects.snake", "parentId": "root", "path": "projects/snake", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CRvz5Xpm.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js?client-route=1", "imports": [], "css": [] }, "routes/projects.loto": { "id": "routes/projects.loto", "parentId": "root", "path": "projects/loto", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BBnv_eBA.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/projects.node": { "id": "routes/projects.node", "parentId": "root", "path": "projects/node", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-B2yiMYgw.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/segmented-control-DH74YI-q.js", "/assets/spr-storyboarder-light-D1EohjcX.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/segmented-control-YyiQlQqP.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-2IKfD1SI.css"] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-D2Kf2wPR.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/divider-DbfiyrM1.js", "/assets/meta-B1CoTWRj.js", "/assets/image-oJgo2LrI.js", "/assets/useParallax-DFSrJPv2.js", "/assets/useScrollToHash-eW_re39o.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/list-CrYKZOe3.js", "/assets/index-L_4ix5aQ.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/list-DkijDrbu.css", "/assets/route-CMd6_K8x.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DujG6SY6.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/index-BXn5pOIG.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/use-spring-KDm3mUsa.js", "/assets/config-DwugsCvJ.js", "/assets/decoder-text-D_l7SzBd.js", "/assets/divider-DbfiyrM1.js", "/assets/meta-B1CoTWRj.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css", "/assets/route-DZ4V55Yk.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-VOWI_I0t.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/index-BXn5pOIG.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/use-spring-KDm3mUsa.js", "/assets/slice-app-placeholder-BfRsQMSa.js", "/assets/yaspeez-screen-large-DTY4msaF.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-B1CoTWRj.js", "/assets/decoder-text-D_l7SzBd.js", "/assets/image-oJgo2LrI.js", "/assets/useScrollToHash-eW_re39o.js", "/assets/divider-DbfiyrM1.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-CIi7OezI.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-B0j0lWmR.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-h3NAstWE.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/image-oJgo2LrI.js", "/assets/meta-B1CoTWRj.js", "/assets/useParallax-DFSrJPv2.js", "/assets/list-CrYKZOe3.js", "/assets/project-CNpk0408.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/list-DkijDrbu.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-CJWqkCSj.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-CAUWKgXd.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/index-BXn5pOIG.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/use-spring-KDm3mUsa.js", "/assets/decoder-text-D_l7SzBd.js", "/assets/image-oJgo2LrI.js", "/assets/error-CDMDmfeF.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-CQFqa4Pm.css", "/assets/error-CmEnn51Q.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-VOWI_I0t.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DyI8Xui0.js", "/assets/config-DwugsCvJ.js", "/assets/index-BXn5pOIG.js", "/assets/visually-hidden-W3ID0zqx.js", "/assets/use-spring-KDm3mUsa.js", "/assets/slice-app-placeholder-BfRsQMSa.js", "/assets/yaspeez-screen-large-DTY4msaF.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-B1CoTWRj.js", "/assets/decoder-text-D_l7SzBd.js", "/assets/image-oJgo2LrI.js", "/assets/useScrollToHash-eW_re39o.js", "/assets/divider-DbfiyrM1.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-CIi7OezI.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-B0j0lWmR.css"] } }, "url": "/assets/manifest-744c33e3.js", "version": "744c33e3" };
...
const routes = {
  ...
  "routes/projects.art-cote-jardin": {
    id: "routes/projects.art-cote-jardin",
    parentId: "root",
    path: "projects/art-cote-jardin",
    index: void 0,
    caseSensitive: void 0,
    module: route2
  },
  ...
  "routes/projects.calculatrice": {
    id: "routes/projects.calculatrice",
    parentId: "root",
    path: "projects/calculatrice",
    index: void 0,
    caseSensitive: void 0,
    module: route4
  },
  ...
  "routes/projects.puppy-clean": {
    id: "routes/projects.puppy-clean",
    parentId: "root",
    path: "projects/puppy-clean",
    index: void 0,
    caseSensitive: void 0,
    module: route6
  },
  ...
  "routes/projects.morpion": {
    id: "routes/projects.morpion",
    parentId: "root",
    path: "projects/morpion",
    index: void 0,
    caseSensitive: void 0,
    module: route8
  },
  "routes/projects.netflix": {
    id: "routes/projects.netflix",
    parentId: "root",
  ...
  "routes/projects.yaspeez": {
    id: "routes/projects.yaspeez",
    parentId: "root",
    path: "projects/yaspeez",
    index: void 0,
    caseSensitive: void 0,
    module: route10
  },
  "routes/projects.flyers": {
    id: "routes/projects.flyers",
    parentId: "root",
    path: "projects/flyers",
    index: void 0,
    caseSensitive: void 0,
    module: route11
  },
  ...
  "routes/projects.loto": {
    id: "routes/projects.loto",
    parentId: "root",
    path: "projects/loto",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/projects.node": {
    id: "routes/projects.node",
    parentId: "root",
    path: "projects/node",
    index: void 0,
    caseSensitive: void 0,
